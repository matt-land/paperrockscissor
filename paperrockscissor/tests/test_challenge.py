...
class TestChallenge(TestCase):
    ...
    def test_player1_wins(self):
        ...
        val = paperrockscissor.challenge(paperrockscissor.PAPER, paperrockscissor.ROCK)
        self.assertEqual(paperrockscissor.PLAYER1, val)
        val = paperrockscissor.challenge(paperrockscissor.SCISSOR, paperrockscissor.PAPER)
        self.assertEqual(paperrockscissor.PLAYER1, val)
    ...
    def test_player2_wins(self):
        ...
        val = paperrockscissor.challenge(paperrockscissor.ROCK, paperrockscissor.PAPER)
        self.assertEqual(paperrockscissor.PLAYER2, val)
        val = paperrockscissor.challenge(paperrockscissor.SCISSOR, paperrockscissor.ROCK)
        self.assertEqual(paperrockscissor.PLAYER2, val)
